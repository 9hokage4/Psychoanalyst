...
def process_data(
    ...
    # Округляем числовые значения до десятых
    numeric_cols = df_result.select_dtypes(include=['float64', 'float32']).columns
    df_result[numeric_cols] = df_result[numeric_cols].round(1)
